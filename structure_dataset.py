...
train_dataset = [tokenizer(sentence, return_tensors='pt', padding='max_length', max_length=1024, truncation=True)['input_ids'].long().squeeze(0) for sentence in tqdm(dataset['train'][:30000]['text'])]
